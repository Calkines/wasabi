...
public class CassandraAssignmentsRepositoryTest {
        ...
        public void testGetAssignmentsMultiple() {
                ...
                result.forEach(pair -> {
                        assertThat(mocked.stream().map(t -> t.getExperimentId()).collect(Collectors.toList()),
                                        hasItems(pair.getLeft().getID().getRawID()));
                });
        ...
        public void testGetAssignmentFromStreamMultiple() {
                ...
                mockedResult.add(Assignment.newInstance(Experiment.ID.valueOf(experimentId))
                                .withBucketLabel(Bucket.Label.valueOf("label1")));
                Bucket mockedBucket = Bucket
                                .newInstance(Experiment.ID.valueOf(experimentId), Bucket.Label.valueOf("label1"))
                                .withAllocationPercent(1.0)
                                .withState(Bucket.State.EMPTY)
                                .build();
                when(experimentRepository.getBucket(eq(Experiment.ID.valueOf(experimentId)),
                                eq(Bucket.Label.valueOf("label1"))))
                                .thenReturn(mockedBucket);
                thrown.expect(RepositoryException.class);
                thrown.expectMessage(
                                "Multiple element fetched from db for experimentId = \"4d4d8f3b-3b81-44f3-968d-d1c1a48b4ac8\" userID = \"testuser1 context=\"test\"");
                repository.getAssignmentFromStream(Experiment.ID.valueOf(experimentId), User.ID.valueOf("testuser1"),
                                Context.valueOf("test"), mockedResult.stream());
        }
        ...
        public void testGetAssignmentStreamNoExperimentExceptionIgnoreNullBuckets() {
                ...
                StreamingOutput result = spyRepository.getAssignmentStream(experimentId, context, mockParameters,
                                false);
        ...
        public void testRemoveIndexExperimentsToUser() {
                ...
                verify(experimentUserIndexAccessor, times(1))
                                .deleteBy(eq("testuser1"), eq(this.experimentId), eq("test"),
        ...
        public void testRemoveIndexExperimentsToUserWriteException() {
                ...
                thrown.expect(RepositoryException.class);
                thrown.expectMessage(
                                "Could not delete index from experiment_user_index for user: testuser1to experiment: 4d4d8f3b-3b81-44f3-968d-d1c1a48b4ac8");
                repository.removeIndexExperimentsToUser(User.ID.valueOf("testuser1"),
                                Experiment.ID.valueOf(this.experimentId),
                                Context.valueOf("test"),
                                APPLICATION_NAME);
    ...
    public void testDeleteFromStaging(){
        ...
        public void testPushAssignmentsToStaging() {
                ...
                // ----- Verify result
                verify(stagingAccessor, times(3)).batchInsertBy(any(UUID.class), eq("type"), eq("string1"),
                                any(String.class));
        }
        ...
        public void testPushAssignmentsToStagingWriteException() {
                ...
                // ------ Mocking interacting calls
                doThrow(WriteTimeoutException.class).when(stagingAccessor).batchInsertBy(any(UUID.class), eq("type"),
                                eq("string1"), any(String.class));
                ResultSet genericResultSet = mock(ResultSet.class);
                when(driver.getSession()).thenReturn(mock(Session.class));
                when(driver.getSession().execute(any(BatchStatement.class))).thenReturn(genericResultSet);
        ...
        public void testUpdateBucketAssignmentCountrWriteException() {
                ...
                thrown.expect(RepositoryException.class);
                thrown.expectMessage(
                                "Could not update the bucket count for experiment 4d4d8f3b-3b81-44f3-968d-d1c1a48b4ac8 bucket NULL");
                repository.updateBucketAssignmentCount(mockedExperiment, mockedAssignment, false);
        }
        ...
        public void testIndexExperimentToUserWithBucketWriteException() {
                Assignment assignment = Assignment.newInstance(Experiment.ID.valueOf(this.experimentId))
                                ...
                                .build();
                doThrow(WriteTimeoutException.class).when(experimentUserIndexAccessor)
                                .insertBy(any(String.class), any(String.class), any(String.class), any(UUID.class),
                                                any(String.class));
                thrown.expect(RepositoryException.class);
        ...
        public void testBucketAssignmentCount() {
                ...
                for (int i = 0; i < mockedList.size(); i++) {
                        ...
                        assertThat(assignmentCounts.getAssignments().get(i).getCount(),
                                        is(mockedList.get(i).getCount()));
                }
        ...
        public void testPopulateExperimentMetadataSuccessCase() throws ExecutionException, InterruptedException {
                ...
                ExperimentBatch experimentBatch = ExperimentBatch.newInstance()
                                .withProfile(segmentationProfile.getProfile()).build();
                ...
                ListenableFuture<Result<com.intuit.wasabi.repository.cassandra.pojo.Experiment>> experimentsFuture = mock(
                ...
                com.intuit.wasabi.repository.cassandra.pojo.Experiment exp1 = com.intuit.wasabi.repository.cassandra.pojo.Experiment
                                .builder()
                                .id(expId1.getRawID())
                ...
                ListenableFuture<Result<com.intuit.wasabi.repository.cassandra.pojo.Application>> applicationFuture = mock(
                                ListenableFuture.class);
                ...
                com.intuit.wasabi.repository.cassandra.pojo.Application app1 = com.intuit.wasabi.repository.cassandra.pojo.Application
                                .builder()
                                .appName(appName.toString())
                ...
                ListenableFuture<Result<ExperimentUserByUserIdContextAppNameExperimentId>> userAssignmentFuture = mock(
                                ListenableFuture.class);
                Bucket.Label bucketLabel = Bucket.Label.valueOf("testBucket1");
                when(experimentUserIndexAccessor.asyncSelectBy(userID.toString(), appName.toString(),
                                context.toString())).thenReturn(userAssignmentFuture);
                List<ExperimentUserByUserIdContextAppNameExperimentId> userAssignmentList = new ArrayList<>();
                ExperimentUserByUserIdContextAppNameExperimentId ua1 = ExperimentUserByUserIdContextAppNameExperimentId
                                .builder()
                                .experimentId(expId1.getRawID())
                                .appName(appName.toString())
                ...
                ListenableFuture<Result<com.intuit.wasabi.repository.cassandra.pojo.Bucket>> bucketFuture = mock(
                                ListenableFuture.class);
                ...
                com.intuit.wasabi.repository.cassandra.pojo.Bucket bucket1 = com.intuit.wasabi.repository.cassandra.pojo.Bucket
                                .builder()
                ...
                ListenableFuture<Result<com.intuit.wasabi.repository.cassandra.pojo.Exclusion>> exclusionFuture = mock(
                                ListenableFuture.class);
                ...
                com.intuit.wasabi.repository.cassandra.pojo.Exclusion exclusion1 = com.intuit.wasabi.repository.cassandra.pojo.Exclusion
                                .builder().base(expId1.getRawID()).pair(exclusionExpId1.getRawID()).build();
                ...
                // ------ Actual call ---------
                repository.populateAssignmentsMetadata(userID, appName, context, experimentBatch,
                                allowAssignmentsOptional, appPriorities, experimentMap, bucketMap, exclusionMap);
