...
public class AuthorizationResourceTest {
        ...
        public void getRolePermissions() throws Exception {
                ...
                AuthorizationResource authorizationResource = new AuthorizationResource(authorization,
                                new HttpHeader("jaba-???", "600"));

                HashMap<String, Object> result = new HashMap<>();

                when(authorization.getPermissionsFromRole(Role.READONLY))
                                .thenReturn(Role.READONLY.getRolePermissions());
        ...
        public void testGetUserList() throws Exception {
                ...
                permissionsList.addPermissions(UserPermissions
                                .newInstance(TESTAPP, Collections.singletonList(Permission.ADMIN)).build());
