...
public class BucketsImplTest {
        ...
        public void testCreateBucket() throws Exception {
                ...
                final Bucket newBucket = Bucket.newInstance(experimentID, bucketLabel).withAllocationPercent(.3)
                                .build();
                ...
                when(cassandraRepository.getBucket(newBucket.getExperimentID(), newBucket.getLabel()))
                                .thenReturn(bucket);
                ...
                verifyException(bucketsImpl, RepositoryException.class).createBucket(experimentID, newBucket,
                                changeUser);
        ...
        public void testAdjustAllocationPercentages() {
                ...
                Bucket bucket = Bucket.newInstance(experimentID, Bucket.Label.valueOf("a")).withAllocationPercent(.4)
                                .build();
                Bucket bucket2 = Bucket.newInstance(experimentID, Bucket.Label.valueOf("b")).withAllocationPercent(.6)
                                .build();
        ...
        public void testGetBucketChangeList() throws Exception {
                ...
                Bucket bucket = Bucket.newInstance(experimentID, bucketLabel)
                                .withControl(true).withAllocationPercent(.5).withDescription("one").withPayload("pay1")
                                .build();
                Bucket bucket2 = Bucket.newInstance(Experiment.ID.newInstance(), bucketLabel)
                                .withControl(false).withAllocationPercent(.6).withDescription("two").withPayload("pay2")
                                .build();
                ...
                changeData = new Bucket.BucketAuditInfo("description", bucket.getDescription(),
                                bucket2.getDescription());
                changes.add(changeData);
        ...
        public void testUpdateBucket() throws Exception {
                ...
                Experiment experiment = Experiment.withID(experimentID)
                                ...
                                .build();
                Bucket bucket = Bucket.newInstance(experimentID, bucketLabel)
                                .withControl(true).withAllocationPercent(.5).withDescription("one")
                ...
                Bucket.BucketAuditInfo changeData = new Bucket.BucketAuditInfo("allocation",
                                bucket.getAllocationPercent().toString(),
        ...
        public void testDeleteBucket() {
                ...
                doThrow(new RepositoryException()).when(databaseRepository).deleteBucket(experimentID,
                                bucket.getLabel());
                try {
                        bucketsImpl.deleteBucket(experimentID, bucket.getLabel(), changeUser);
        ...
        public void testGetBucketBuilder() {
                ...
                Experiment experiment = Experiment.withID(experimentID)
                                ...
                                .withState(Experiment.State.DRAFT)
                                .build();
                verifyException(bucketsImpl, BucketNotFoundException.class).getBucketBuilder(experiment.getID(),
                                bucketLabel);
