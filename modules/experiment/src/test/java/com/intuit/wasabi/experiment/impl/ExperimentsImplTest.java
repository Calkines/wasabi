...
public class ExperimentsImplTest {
    ...
    // doThrow(new
    // RepositoryException()).when(cassandraRepository).createExperiment(testExp);
    ...
    // times(1)).createExperiment(any(NewExperiment.class));
    ...
    // doNothing().when(validator).validateNewExperiment(testExp);
    // doThrow(new
    // RepositoryException()).when(databaseRepository).createExperiment(testExp);
    ...
    // times(0)).createExperiment(any(NewExperiment.class));
    ...
    // when(cassandraRepository.getExperiment(testApp,
    // testLabel)).thenReturn(testExp);
    // experiment = expImpl.getExperiment(testApp, testLabel);
    // assert experiment.getID() == experimentID;
    ...
    // verify(validator, never()).validateStateTransition(currentState,
    // desiredState);
    ...
    // expImpl.checkStateTransition(experimentID, Experiment.State.DRAFT,
    // Experiment.State.RUNNING);
    // verify(validator, times(1)).validateStateTransition(Experiment.State.DRAFT,
    // Experiment.State.RUNNING);
    // verify(buckets, times(1)).getBuckets(experimentID, false);
    // verify(validator,
    // times(1)).validateExperimentBuckets(bucketList.getBuckets());
    ...
    // void assertIllegalExperimentEndTime(Experiment mockCurrentExperiment,
    // Experiment mockUpdateExperiment) {
    // try {
    // expImpl.checkForIllegalExperimentEndTime(mockCurrentExperiment,
    ...
    // assertIllegalExperimentStartTime(mockCurrentExperiment,
    // mockUpdateExperiment);
    ...
    // void assertIllegalExperimentStartTime(Experiment mockCurrentExperiment,
    // Experiment mockUpdateExperiment) {
    // try {
    // expImpl.checkForIllegalExperimentStartTime(mockCurrentExperiment,
    // mockUpdateExperiment);
    // fail();
    // } catch (Exception e) {
    // assertEquals(e.getClass(), IllegalArgumentException.class);
    ...
    // Experiment mockCurrentExperiment = mock(Experiment.class);
    // Experiment mockUpdateExperiment = mock(Experiment.class);
    // doNothing().when(expImpl).checkForIllegalExperimentStartTime(mockCurrentExperiment,
    // mockUpdateExperiment);
    // doNothing().when(expImpl).checkForIllegalExperimentEndTime(mockCurrentExperiment,
    // mockUpdateExperiment);
    ...
    // try {
    // expImpl.checkForIllegalPausedRunningUpdate(mockCurrentExperiment,
    // mockUpdateExperiment);
    // } catch (Exception e) {
    // assertEquals(e.getClass(), IllegalArgumentException.class);
    ...
    // mockUpdateExperiment);
    // verify(expImpl,
    // times(1)).checkForIllegalExperimentStartTime(mockCurrentExperiment,
    // mockUpdateExperiment);
    ...
    // mockUpdateExperiment);
    // verify(expImpl,
    // times(1)).checkForIllegalExperimentEndTime(mockCurrentExperiment,
    // mockUpdateExperiment);
    ...
    // expImpl.updateExperiment(experimentID, updateExp,
    // UserInfo.from(UserInfo.Username.valueOf("user")).build());
    // }
    ...
    // boolean requiresUpdate = expImpl.buildUpdatedExperiment(current, update,
    // builder, changeList);
    ...
    // requiresUpdate = expImpl.buildUpdatedExperiment(current, update, builder,
    // changeList);
    ...
    // verify(builder, times(1)).withLabel(Experiment.Label.valueOf("Label-2")); //
    // change to this does not trigger
    // // experiment audit info
    // verify(builder,
    // times(1)).withApplicationName(Application.Name.valueOf("App2")); // change to
    // this does not
    ...
    // cassandraRepository, experiments,
    // buckets, pages, priorities, validator, ruleCache, eventLog));
    // when(cassandraRepository.getExperiments()).thenReturn(mock(List.class));
    ...
    // doReturn(false).when(_expImpl).buildUpdatedExperiment(eq(current),
    // eq(update),
    ...
    // // verify(experiments,
    // times(1)).checkStateTransition(any(Experiment.ID.class),
    ...
    // // verify(databaseRepository,
    // times(1)).updateExperiment(any(Experiment.class));
    // // verify(priorities,
    // times(1)).appendToPriorityList(any(Experiment.ID.class));
    // // verify(cassandraRepository,
